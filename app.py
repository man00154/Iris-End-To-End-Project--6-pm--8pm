...
# create a header browser
st.set_page_config(page_title='Iris Project - Manish Singh')

# Add atitle in browser body
st.title("Iris End to End Project - Manish Singh")

#Take  Sepal_length, Sepal_width, petal_length, petal_width
